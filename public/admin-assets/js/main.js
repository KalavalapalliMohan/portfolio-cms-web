(function ($) {
    ...
    if (typeof Chart !== "undefined") {
        ...
        // Worldwide Sales
        const worldwide = document.getElementById("worldwide-sales");

        if (worldwide) {
            new Chart(worldwide.getContext("2d"), {
                type: "bar",
                data: {
        ...
        // Sales Revenue
        const salesRevenue = document.getElementById("salse-revenue");

        if (salesRevenue) {
            new Chart(salesRevenue.getContext("2d"), {
                type:"line",
                data:{
                    labels:["2016","2017","2018","2019","2020","2021","2022"],
                    datasets:[
